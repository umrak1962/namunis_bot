...
T = {
    "uz": {
        ...
        "main_menu": "Qaysi xizmatdan foydalanmoqchisiz?",
        ...
        "eq_type": (
            ...
            "(Masalan: suv idish to'ldirish liniyasi, kraker ishlab chiqarish...)"
        ),
        "eq_capacity": (
        ...
        "eq_budget": (
            ...
            "(Masalan: $10,000 – $30,000)"
        ),
        "src_product": (
            "🌏 *Xitoydan yuk / Sourcing*\n\n"
            "1️⃣ Qanday mahsulot olib kelmoqchisiz?\n"
            "(Masalan: kiyim-kechak, elektronika, qurilish materiallari...)"
        ),
        "src_quantity": (
        ...
        "contact_phone": "📞 Telefon raqamingizni yuboring:",
    ...
    "ru": {
        ...
        "eq_type": (
            ...
            "(Например: линия розлива воды, производство крекеров...)"
        ),
        "eq_capacity": (
        ...
        "eq_budget": (
            ...
            "(Например: $10,000 – $30,000)"
        ),
        "src_product": (
            "🌏 *Груз из Китая / Сорсинг*\n\n"
            "1️⃣ Какой товар хотите привезти?\n"
            "(Например: одежда, электроника, стройматериалы...)"
        ),
        "src_quantity": (
        ...
        "contact_phone": "📞 Отправьте номер телефона:",
...
def kb(buttons):
    return ReplyKeyboardMarkup([[b] for b in buttons], resize_keyboard=True, one_time_keyboard=True)
...
async def main_menu(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    txt = update.message.text
    if "Uskuna" in txt or "борудовани" in txt:
